...
export const Left = () => {
  return (
    <div className="component-description__list">
      {list.map((item: any) => {
        return (
          <div className="component-description__item">
            <div className="component-description__item-header">{item.category}</div>
            <div className='component-description__item-content'>
              {item.list.map((item2: any) => {
                return (
                  <div className='component-description__item-nippet'>{item2.componentName}</div>
                )
              })}
            </div>
          </div>
